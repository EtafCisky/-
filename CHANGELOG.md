...
## [3.3.6] - 2026-03-26 (功能新增版)

### ✨ 新增功能

改名功能

- 添加"改名"命令，允许玩家修改道友名字（nickname）
- 与"改道号"不同，改名功能修改的是显示名字，不检查重复
- 名字长度限制为12个字符
- 新增 `PlayerService.change_name()` 方法
- 新增 `PlayerHandler.handle_change_name()` 处理器
- 新增 `Commands.CHANGE_NAME` 常量
- 使用方法：发送"改名 新的名字"

### 📝 说明

- "改道号"：修改道号（user_name），会检查是否与其他玩家重复
- "改名"：修改显示名字（nickname），不检查重复，可以随意修改
